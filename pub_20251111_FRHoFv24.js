...
AddSubClass("cleric", "knowledge", {
    ...
    features: {
        "subclassfeature3": {
            ...
            description: desc([
                "I gain Proficiency with one Artisan's Tools set.", 
				"I also gain Proficiency and Expertise in two of the following skills: Arcana, History, Nature, Religion.",
            ]),
        },
        "subclassfeature3.1": {
            name: "Channel Divinity: Mind Magic",
            source: ["FR:HoF", 18],
            minlevel: 3,
            action: ["action", ""],
            description: desc([
        ...
        "subclassfeature17": {
            ...
            altResource: "SS 6+",
            description: desc([
                "Once per Long Rest as a Bns, I give myself Adv on all D20 Tests for 1 hr.", 
				"I can also restore my use of this feature by expending a level 6+ spell slot (no action needed).",
            ]),
        },
    },
});
AddSubClass("fighter", "banneret", {
    ...
    features: {
        "subclassfeature3": {
            ...
            description: desc([
                ...
                "***Polyglot***. I learn one language from the language tables in the PHB'24 or chapter 2 of FR:HoF. When I finish a Long Rest, I can replace the language from this benefit with another language I've heard, seen signed, or read in the past 24 hours.",
...
AddSubClass("paladin", "oath of the noble genies", {
    ...
    features: {
        ...
        "subclassfeature7": {
            ...
            minlevel: 7,
            description: desc([
                "Choose one of the following dmg types: Acid, Cold, Fire, Lightning, or Thunder.", 
				"My allies and I have Resistance to that dmg type while in my Aura of Protection.", 
				"At my turn start, I can change the dmg type for this feature to another listed option (no action needed).",
            ]),
        },
        "subclassfeature15": {
        ...
        "subclassfeature20": {
            ...
            description: desc([
                "Once per Long Rest as a Bns, I gain the following benefits for 10 min or until I end them (no action needed).", 
				"I can restore my use of this feature by expending a level 5 spell slot (no action needed).",
...
AddSubClass("ranger", "winter walker", {
    ...
    features: {
        ...
        "subclassfeature3.1": {
            ...
            description: desc([
                "When I cast Hunter's Mark, I gain Temp HP equal to 1d10 plus my Ranger level.", 
				"While a crea is marked by my Hunter's Mark, it can't take the Disengage action.",
            ]),
        },
        "subclassfeature7": {
            ...
            action: ["action", ""],
            description: desc([
                "Once per Long Rest as a Magic Action, choose a number of visible crea equal to my Wis mod (min 1).", 
				"Each crea regains HP equal to 1d10 plus my Ranger level, and has Adv on saves to avoid or end the Frightened condition for 1 hr.",
            ]),
        },
        "subclassfeature11": {
        ...
        "subclassfeature15": {
            ...
            altResource: "SS 4+",
            description: desc([
                "Once per Long Rest when I cast Hunter's Mark, I can adopt a ghostly, snowy form. It lasts until the spell ends, giving me the following benefits.", 
				"I can regain my use of this feature by expending a lvl 4+ Spell slot (no action needed).",
...
AddSubClass("sorcerer", "spellfire sorcery", {
    ...
    features: {
        ...
        "subclassfeature18": {
            ...
            altResource: "5 SP",
            description: desc([
                "Once per Long Rest when I use Innate Sorcery, I can alter it to gain the following benefits.", 
				"I can regain my use of this feature by expending 5 SP (no action needed).",
...
FeatsList["lordly resolve"] = {
    ...
    action: ["bonus action", "Standard Bearer"],
...
FeatsList["boon of terror"] = {
    ...
    action: ["reaction", "Flee, Fools! (vs Frightened target)"],
    extraLimitedFeatures: [{
        name: "Flee, Fools!",
        usages: 1,
        recovery: "short rest",
...
FeatsList["boon of the furious storm"] = {
    ...
    savetxt: { immune: ["Lightning while Bloodied; ", "Thunder while Bloodied; "], },
