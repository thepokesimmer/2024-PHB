...
FeatsList.blessings = {
    ...
    "magic resistance": {
        ...
        savetxt: {
            adv_vs: ["spells and other magical effects; "]
        },
...
FeatsList.charms = {
    ...
    "dragon slayer": {
        ...
        descriptionFull: [
            "One weapon in your possession becomes a Dragon Slayer weapon for the next 9 days. The Charm then vanishes from you, and the weapon returns to normal.",
        ],
        toNotesPage: [{
            name: "Charm of the Dragon Slayer",
    ...
    "giant slayer": {
        ...
        descriptionFull: [
            "One weapon in your possession becomes a Giant Slayer weapon for the next 9 days. The Charm then vanishes from you, and the weapon returns to normal.",
        ],
        toNotesPage: [{
            name: "Charm of the Giant Slayer",
...
MagicItemsList.grenade = {
    ...
    descriptionFull: "As an action, you can either throw a grenade at a point up to 60 feet away or use a Grenade Launcher to propel the grenade to a point up to 1000 feet away. The grenade explodes at that point, creating a particular effect in a 20-foot-radius Sphere.",
    action: [
        ["action", "Throw Explosive"]
    ],
...
MagicItemsList["armor of vulnerability"] = { // contains contributions by Larry Hoy
    ...
    "bludgeoning": {
        ...
        dmgres: ["Bludgeoning"],
        savetxt: {
            text: ["Vulnerable to Piercing \u0026 Slashing damage"]
        },
    ...
    "piercing": {
        ...
        dmgres: ["Piercing"],
        savetxt: {
            text: ["Vulnerable to Bludgeoning \u0026 Slashing damage"]
        },
    ...
    "slashing": {
        ...
        dmgres: ["Slashing"],
        savetxt: {
            text: ["Vulnerable to Bludgeoning \u0026 Piercing damage"]
        },
...
MagicItemsList.blackrazor = {
    ...
    prereqeval: function(v) {
        return !(/lawful/i).test(What("Alignment"));
    },
    weight: 6,
    weaponOptions: [{
    ...
    toNotesPage: [{
        name: "Features",
        note: desc(DMG_blackrazorFullDescription).replace(/>>(.*?)<</g, function(a, match) {
            return match.toUpperCase();
        }).replace(/your/g, "my").replace(/you are /ig, "I am ").replace(/(of|on|reduces|grants) you/ig, "$1 me").replace(/you /ig, "I ") + "\n\n" + sentientItemConflictTxt
    }],
    savetxt: {
...
MagicItemsList["candle of invocation"] = {
    ...
    rarity: "very rare",
    magicItemTable: "?",
    description: "This slender taper is connected to a plane of existence. Lit, it sheds dim light in a 30-ft radius for up to 4 hours and grants me Advantage on d20 Tests, Clerics and Druids in its light can cast level 1 spells they have prepared without expending a spell slot. I can destroy an unlit candle to cast Gate which links to the candle's associated plane of existence.",
...
MagicItemsList["cloak of protection"] = {
    ...
    extraAC: [{
        ...
        mod: 1,
        magic: true,
        text: "I gain a +1 bonus to AC while attuned."
    }],
    addMod: [{
        type: "save",
        field: "all",
...
MagicItemsList["dark shard amulet"] = {
    ...
    prereqeval: function(v) {
        return classes.known.warlock ? true : false;
    },
    usages: 1,
    recovery: "long rest",
    calcChanges: {
...
MagicItemsList["demon armor"] = { // contains contributions by Larry Hoy
    ...
    savetxt: {
        text: ["Disadv. on saves vs. demons"]
    },
    chooseGear: {
        type: "armor",
...
MagicItemsList["eyes of the eagle"] = {
    ...
    vision: [
        ["Adv. on Perception checks that rely on sight", 0]
    ]
};
...
MagicItemsList["hat of many spells"] = {
    ...
    prereqeval: function(v) {
        return classes.known.wizard ? true : false;
    },
    spellcastingAbility: "class"
};
...
MagicItemsList["nature's mantle"] = {
    ...
    prereqeval: function(v) {
        return classes.known.druid || classes.known.ranger ? true : false;
    },
...
MagicItemsList["necklace of prayer beads"] = {
    ...
    prereqeval: function(v) {
        return classes.known.druid || classes.known.paladin || classes.known.cleric ? true : false;
    },
    weight: 1,
    usages: "1d4+2",
    recovery: "dawn",
...
MagicItemsList["pipes of haunting"] = { // contains contributions by Soilentbrad
    ...
    rarity: "uncommon",
    magicItemTable: "?",
    description: "These pipes have 3 charges and regain 1d3 expended charges daily at dawn. As a Magic action, I can use 1 charge to play them and have each creature in 30 ft that can hear them make a DC 15 Wisdom saving throw or be frightened of me for 1 minute. A target can repeat the save at the end of each of their turns.",
...
MagicItemsList["plate armor of etherealness"] = {
    ...
    "half plate": {
        ...
        descriptionFull: "While you’re wearing this half plate armor, you can take a Magic action and use a command word to gain the effect of the Etherealness spell. The spell ends immediately if you remove the armor or take a Magic action to repeat the command word. This property of the armor can’t be used again until the next dawn.\n Plate consists of shaped, interlocking metal plates to cover the entire body. A suit of plate includes gauntlets, heavy leather boots, a visored helmet, and thick layers of padding underneath the armor. Buckles and straps distribute the weight over the body.",
        armorOptions: {
...
MagicItemsList["potion of invulnerability"] = {
    ...
    source: [
        ["SRD24", 188]
    ], //Listed on DDB as Free Rules 2024, 188
    type: "potion",
    rarity: "rare",
    magicItemTable: "?",
...
MagicItemsList["quarterstaff of the acrobat"] = {
    ...
    rarity: "very rare",
    magicItemTable: "?",
    description: "This magic quarterstaff adds a +2 bonus to attack and damage rolls made with it. While holding this weapon, I can emit a dim green light (10ft) as a Bonus Action or after you roll Initiative and can extinguish the light as a Bonus Action. You can take a Bonus Action to alter its form, turning it into a 6-inch rod or 10-foot pole, or revert it back to its Quarterstaff form.",
    ...
    modifiers: [2, 2],
    action: [
        ["bonus action", "Dim Light/Extinguish Light"],
        ["bonus action", "Transform Staff"],
        ["reaction", "Attack Deflection (+5AC)"]
    ],
    savetxt: {
        adv_vs: ["Acrobatics"]
    },
...
MagicItemsList["ring of free action"] = {
    ...
    attunement: true,
    savetxt: {
        immune: ["paralyzed (by magic)", "restrained (by magic)"]
    }
};
...
MagicItemsList["ring of mind shielding"] = {
    ...
    attunement: true,
    action: [
        ["action", " (im)perceptible"]
    ],
    savetxt: {
        immune: ["magic reading my thoughts, truthfullness, alignment, or type"]
    }
};
...
MagicItemsList["robe of eyes"] = { // contains contributions by SoilentBrad
    ...
    rarity: "rare",
    magicItemTable: "?",
    description: "This robe gives you the following benefits: Advantage on sight-based Perception checks; Darkvision and Truesight up to 120-ft. If Light is cast on it or Daylight within 5 ft of it, you're blinded for 1 min, Con save (DC 11-Light, 15-Daylight) at the end of my each of my turns until successful.",
...
MagicItemsList["robe of stars"] = { // contains contributions by SoilentBrad
    ...
    addMod: [{
        ...
        field: "all",
        mod: 1,
        text: "While wearing the Robe of Stars, I gain a +1 bonus to all my saving throws."
    }],
    spellFirstColTitle: "Ch",
    spellcastingBonus: {
        name: "1 charge",
...
MagicItemsList["rod of alertness"] = { // contains contributions by SoilentBrad
    ...
    vision: [
        ["Bright Light: Sense Invisible", 0]
    ],
    action: [
        ["action", ""]
    ],
...
MagicItemsList["shield of the cavalier"] = {
    ...
    rarity: "very rare",
    magicItemTable: "?",
    description : "While holding this Shield, I have an extra +2 bonus to AC. Shield can be used for 1 atk of the Attack action vs target in 5 ft. Also has a once per dawn Reaction, see Notes.",
		descriptionLong : "While holding this shield, I gain an extra +2 bonus to AC. When I take the Attack action, I can make 1 of the attacks with the shield vs a target in 5 ft. It does 2d6 + 2 + Str Force dmg and can Push target 10 ft. Can also knock Prone if target is my size or smaller. As a Reaction once per dawn, if me or ally in 5 ft is targeted by an attack or saves vs an AOE, I can create an immobile 5-ft Emanation around me. Any creature or object not fully in sphere is pushed to nearest empty space. Nothing can pass in or out, including triggering effect. It lasts for up to 1 min and takes Concentration.",
...
MagicItemsList["staff of charming"] = {
    ...
    prereqeval: function(v) {
        return classes.known.bard || classes.known.cleric || classes.known.druid || classes.known.sorcerer || classes.known.warlock || classes.known.wizard ? true : false;
    },
    extraLimitedFeatures: [{
    ...
    action: [
        ["reaction", "reflect enchantment (1 charge)"]
    ],
};
MagicItemsList["staff of fire"] = {
    ...
    prereqeval: function(v) {
        return classes.known.druid || classes.known.sorcerer || classes.known.warlock || classes.known.wizard ? true : false;
    },
    usages: 10,
    recovery: "dawn",
    additional: "regains 1d6+4",
...
MagicItemsList["staff of power"] = {
    ...
    extraAC: [{
        ...
        mod: 2,
        magic: true,
        text: "I gain a +2 bonus to AC while attuned."
    }],
    action: [
...
MagicItemsList["staff of the woodlands"] = {
    ...
    prereqeval: function(v) {
        return classes.known.druid ? true : false;
    },
    action: [
        ["action", ""]
    ],
...
MagicItemsList["staff of thunder and lightning"] = {
    ...
    weight: 4,
    action: [
        ["action", "Staff of T\u0026L Lightning Strike, Thunderclap"],
        ["bonus action", "Thunder and Lightning"]
    ],
    weaponsAdd: ["Staff of Thunder and Lightning"],
    weaponOptions: {
        baseWeapon: "quarterstaff",
        regExpSearch: /staff of thunder and lightning/i,
        name: "Staff of Thunder and Lightning",
        source: [
            ["SRD", 245],
            ["D", 204]
...
MagicItemsList["sun blade"] = {
    ...
    weight: 3,
    action: [
        ["bonus action", " (Blade of Radiance"],
        ["action", " (change light)"]
    ],
...
MagicItemsList["sword of sharpness"] = {
    ...
    magicItemTable: "?",
    attunement: true,
    description: "When I roll a 20 to hit with this magic weapon vs. a creature, it takes +14 slashing damage and gains 1 exhaustion level. It does maximum damage vs. objects.",
...
MagicItemsList["sword of vengeance"] = {
    ...
    calcChanges: {
        atkAdd: [
            function(fields, v) {
                if (!v.theWea.isMagicWeapon && v.isMeleeWeapon && (/glaive|greatsword|longsword|rapier|scimitar|shortsword/i).test(v.baseWeaponName) && (/of vengeance/i).test(v.WeaponTextName)) {
                    v.theWea.isMagicWeapon = true;
                    fields.Description = fields.Description.replace(/(, |; )?Counts as magical/i, '');
                    fields.Description += (fields.Description ? '; ' : '') + 'Cursed';
                }
        ...
        atkCalc: [
            function(fields, v, output) {
                if (v.isMeleeWeapon && (/glaive|greatsword|longsword|rapier|scimitar|shortsword/i).test(v.baseWeaponName) && (/of vengeance/i).test(v.WeaponTextName)) {
                    output.magic = v.thisWeapon[1] + 1;
                }
            }, ''
        ]
...
MagicItemsList["talisman of the sphere"] = {
    ...
    vision: [
        ["Adv. on Int (Arcana) to control Sphere of Annihil.", 1]
    ],
    weight: 1
};
...
MagicItemsList["wand of wonder"] = {
    ...
    descriptionFull: "This wand has 7 charges. While holding it, you can take a Magic action to expend 1 charge while choosing a point within 120 feet of yourself. That location becomes the point of origin of a spell or other magical effect determined by rolling on the Wand of Wonder Effects table.\n" +
        ...
        toUni("Regaining Charges") + ". The wand regains 1d6+1 expended charges daily at dawn. If you expend the wand's last charge, roll a d20. On a 1, the wand crumbles into dust and is destroyed.\n" + [
            ...
            " 73-77\t\tLeaves grow from the target. If you choose a point in space as the target, leaves sprout from the creature nearest to that point. Unless they are picked off, the leaves turn brown and fall off after 24 hours.",
    ...
    spellcastingBonus: {
        ...
        selection: ["slow", "faerie fire", "gust of wind", "stinking cloud", "lightning bolt", "enlarge/reduce", "darkness", "fireball", "invisibility", "polymorph"],
        times: 10
    },
    spellChanges: {
        "darkness": {
            range: "120 ft",
            changes: "All Wand of Wonder spells have a range of 120 ft."
        },
        "enlarge/reduce": {
            range: "120 ft",
            changes: "All Wand of Wonder spells have a range of 120 ft."
...
MagicItemsList.wave = {
    ...
    toNotesPage: [{
        name: "Features",
        note: desc(DMG_waveFullDescription).replace(/>>(.*?)<</g, function(a, match) {
            return match.toUpperCase();
        }) + "\n\n" + sentientItemConflictTxt,
    }],
    ...
    savetxt: {
        text: 'I can breathe normally underwater'
    },
    extraLimitedFeatures: [{
...
MagicItemsList["weapon of warning"] = {
    ...
    rarity: "uncommon",
    magicItemTable: "?",
    description: "While this weapon is within your reach, and you are attuned to it, you and your allies within 30 ft magically awaken when combat begin, unless a magically induced sleep. You also have Advantage on Initiative rolls.",
...
MagicItemsList.whelm = {
    ...
    toNotesPage: [{
        name: "Features",
        note: desc(DMG_whelmFullDescription).replace(/>>(.*?)<</g, function(a, match) {
            return match.toUpperCase();
        }).replace(/your/g, "my").replace(/you are /ig, "I am ").replace(/(of|on|causes|alerts) you/ig, "$1 me").replace(/you /ig, "I ") + "\n\n" + sentientItemConflictTxt
    }],
    action: [
        ["action", " (Shock Wave)"]
    ],
    ...
    vision: [
        ["Know location of secret doors", 30]
    ],
    spellcastingBonus: [{
        name: "Once per dawn",
...
MagicItemsList["wings of flying"] = {
    ...
    rarity: "rare",
    magicItemTable: "?",
    description: "While wearing this cloak, you can take a Magic action to turn the cloak into a pair of wings on your back. The wings last for 1 hour or until you end the effect early as a Magic action. The wings give a flying speed of 60 ft. When they disappear, you can't use them again for 1d12 hours.",
