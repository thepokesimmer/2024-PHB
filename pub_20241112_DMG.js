...
// Coded By: ThePokésimmer with contributions from Reading Toskr
//Functions
...
MagicItemsList["berserker axe"] = {
	...
	chooseGear : {
		...
		descriptionChange : ["replace", ["axe", "halberd"]],
		excludeCheck : function (inObjKey, inObj) {
...
MagicItemsList["bowl of commanding water elementals"] = {
	...
	rarity : "rare",
	magicItemTable : "?",
	description : "While this bowl is filled with water, I can speak the bowl's command word as a Magic action and summon a water elemental, as if I had cast Conjure Elemental. The bowl can't be used again until the next dawn. The bowl is about 1 foot in diameter and half as deep, and holds about 3 gallons of water.",
