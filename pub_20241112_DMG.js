...
// Coded By: ThePokésimmer with contributions from Reading Toskr, TrackAtNite, and ShadowzAll
//Functions
...
MagicItemsList["mace of disruption"] = {
	...
	rarity: "rare",
	magicItemTable: "?",
	description: "This magic mace sheds bright light in a 20-ft radius and dim light for another 20 ft while held. Fiends and undead hit with it take +2d6 radiant damage. If the target has less than 26 HP after taking the damage, it must make a DC 15 Wis save or be destroyed.  On a successfull save, the creature becomes frightened of me until my next turn ends",
	...
	weaponOptions: {
		...
		description: "Fiend/undead +2d6 radiant damage, and if HP<26, DC 15 Wis save or die, on success frightened until my next turn ends,"
	}
};
MagicItemsList["mace of smiting"] = {
	...
	weaponOptions: {
		...
		name: "Mace of Smiting",
		source: [["SRD", 229], ["D", 179]],
		description: "+1 to hit/damage (+3 vs. constructs); On 20 to hit: +7 damage (+14 vs. constructs); Constructs HP<= 25 destroyed",
		modifiers: [1, 1]
	}
};
MagicItemsList["mace of terror"] = {
	...
	descriptionLong: "This magic mace has 3 charges, regaining 1d3 at dawn. As a magic action, I can expend 1 charge to have each creature of my choice within 30 ft make a DC 15 Wis save or become frightened of me for 1 minute. While frightened in this way, a creature must spend its turns trying to move as far away from me as it can, using its action to Dash or to get away, and it can't willingly move within 30 ft of me and can't take reactions. If it has nowhere it can move, the creature can use the Dodge action. At the end of each of its turns, a creature can repeat the saving throw, ending the effect on itself on a success.",
	descriptionFull: "This magic mace has 3 charges. While holding it, I can use a magic action and expend 1 charge to release a wave of terror. Each creature of your choice in a 30-foot radius from you must succeed on a DC 15 Wisdom saving throw or become frightened of you for 1 minute. While it is frightened in this way, a creature must spend its turns trying to move as far away from you as it can, and it can't willingly move to a space within 30 feet of you. It also can't take reactions. For its action it can use only the Dash action or try to escape from an effect that prevents it from moving. If it has nowhere it can move, the creature can use the Dodge action. At the end of each of its turns, a creature can repeat the saving throw, ending the effect on itself on a success.\n   The mace regains 1d3 expended charges daily at dawn.",
	attunement: true,
	weight: 4,
	usages: 3,
	recovery: "dawn",
...
MagicItemsList["mantle of spell resistance"] = {
	...
	descriptionFull: "I have advantage on saving throws against spells while I wear this cloak.",
	attunement: true,
...
MagicItemsList["manual of bodily health"] = {
	...
	rarity: "very rare",
	magicItemTable: "?",
	description: "This book contains health and diet tips, and its words are charged with magic. If I spend 48 hours within 6 days to study its contents and practicing its guidelines, my Constitution score increases by 2, up to a maximum of 30. The manual then loses its magic, but regains it in a century.",
	descriptionFull: "This book contains health and diet tips, and its words are charged with magic. If you spend 48 hours over a period of 6 days or fewer studying the book's contents and practicing its guidelines, your Constitution score increases by 2, up to a maximum of 30. The manual then loses its magic, but regains it in a century.",
	weight: 5,
...
MagicItemsList["manual of quickness of action"] = {
	...
	rarity: "very rare",
	magicItemTable: "?",
	description: "This book contains coordination and balance exercises, and its words are charged with magic. If I spend 48 hours within 6 days to study its contents and practicing its guidelines, my Dexterity score increases by 2, up to a maximum of 30. The manual then loses its magic, but regains it in a century.",
	descriptionFull: "This book contains coordination and balance exercises, and its words are charged with magic. If I spend 48 hours over a period of 6 days or fewer studying the book's contents and practicing its guidelines, my Dexterity score increases by 2, up to a maximum of 30. The manual then loses its magic, but regains it in a century.",
	weight: 5,
	eval: function () {
...
MagicItemsList["mariner's armor"] = {
	...
	rarity: "uncommon",
	magicItemTable: "?",
	description: "While wearing this armor, I have a swimming speed equal to my walking speed. In addition, whenever I start my turn underwater with 0 hit points, I immediately regain 1d4 hit points. The armor is decorated with fish and shell motifs.",
	descriptionFull: "While wearing this armor, you have a swimming speed equal to your walking speed. In addition, whenever you start your turn underwater with 0 hit points, I immediately regain 1d4 hit points. The armor is decorated with fish and shell motifs.",
	allowDuplicates: true,
	chooseGear: {
		type: "armor",
		prefixOrSuffix: "suffix",
...
MagicItemsList["medallion of thoughts"] = {
	...
	rarity: "uncommon",
	magicItemTable: "?",
	description: "The medallion has 5 charges. While wearing it, I can use an action and expend 1 charge to cast Detect Thoughts (save DC 13) from it. The medallion regains 1d4 expended charges daily at dawn.",
	descriptionFull: "The medallion has 5 charges. While wearing it, you can use an action and expend 1 charge to cast the Detect Thoughts spell (save DC 13) from it. The medallion regains 1d4 expended charges daily at dawn.",
	attunement: true,
	weight: 1,
	usages: 5,
	recovery: "dawn",
...
MagicItemsList["mirror of life trapping"] = {
	...
	descriptionFull: "When this 4-foot-tall, 2 foot wide mirror is viewed indirectly, its surface shows faint images of creatures. The mirror weighs 50 pounds, and it has AC 11, 10 hit points, immunities to poison and psychic, and vulnerability to bludgeoning damage. It shatters and is destroyed when reduced to 0 hit points.\n   If the mirror is hanging on a vertical surface and I am within 5 feet of it, I can use an action to speak its command word and activate it. It remains activated until I use an action to speak the command word again.\n   Anyother creature that sees its reflection in the activated mirror while within 30 feet of it must succeed on a DC 15 Charisma saving throw or be trapped, along with anything it is wearing or carrying, in one of the mirror's twelve extradimensional cells. This saving throw is made with advantage if the creature knows the mirror's nature, and constructs succeed on the save automatically.\n   An extradimensional cell is an infinite expanse filled with thick fog that reduces visibility to 10 feet. Creatures trapped in the mirror's cells don't age, and they don't need to eat, drink, or sleep. A creature trapped within a cell can escape using magic that permits planar travel. Otherwise, the creature is confined to the cell until freed.\n   If the mirror traps a creature but its twelve extradimensional cells are already occupied, the mirror frees one trapped creature at random to accommodate the new prisoner. A freed creature appears in an unoccupied space within sight of the mirror but facing away from it. If the mirror is shattered, all creatures it contains are freed and appear in unoccupied spaces near it.\n   While within 5 feet of the mirror, I can use a Magic action to speak the name of one creature trapped in it or call out a particular cell by number. The creature named or contained in the named cell appears as an image on the mirror's surface. I can communicate with the creature normally.\n   I can use a Magic action to speak a second command word and free one creature trapped in the mirror. The freed creature appears, along with its possessions, in the unoccupied space nearest to the mirror and facing away from it.",
	weight: 50,
	action: [["action", ""]],
	toNotesPage: [{
		name: "Workings of the Mirror",
		note: [
			"When this 4-ft-tall, 2-ft-wide mirror is viewed indirectly, its surface shows faint images of creatures. The mirror weighs 50 lb, has AC 11, 10 HP, is immune to poison and psychic damage and is vulnerable to bludgeoning damage. It shatters and is destroyed when reduced to 0 hit points.",
			"If the mirror is hanging on a vertical surface and I am within 5 ft of it, I can use a Magic action to speak its command word and activate it. It remains activated until I use an action to speak the command word again.",
			...
			"If the mirror traps a creature but its twelve extradimensional cells are already occupied, the mirror frees one trapped creature at random to accommodate the new prisoner. A freed creature appears in an unoccupied space within sight of the mirror but facing away from it. If the mirror is shattered, all creatures it contains are freed and appear in unoccupied spaces near it.",
			"While within 5 ft of the mirror, I can use a Magic action to speak the name of one creature trapped in it or call out a particular cell by number. The creature named or contained in the named cell appears as an image on the mirror's surface and I can then communicate normally with it.",
			"I can also use a magic action to speak a second command word and free one creature trapped in the mirror. The freed creature appears, along with its possessions, in the unoccupied space nearest to the mirror and facing away from it."
		]
	}]
};
...
MagicItemsList["necklace of adaptation"] = {
	...
	descriptionFull: "While wearing this necklace, I can breathe normally in any environment, and I have advantage on saving throws made to avoid or end the Poisoned condition.",
	weight: 1,
	attunement: true,
	savetxt: {
		adv_vs: ["poison"],
...
MagicItemsList["necklace of fireballs"] = {
	...
	rarity: "rare",
	magicItemTable: "?",
	description: "This necklace has 1d6+3 beads hanging from it. As a Magic action, I can detach a bead and throw it up to 60 ft away where it detonates as a 3rd-level Fireball (save DC 15). I can hurl multiple beads as part of the same action, increasing the level of the Fireball by 1 for each bead beyond the first.",
...
MagicItemsList["nine lives stealer"] = {
	...
	calcChanges: {
		atkAdd: [
			...
			'If I include the words "Nine Lives Stealer" in a the name of a melee weapon, it will be treated as the magic weapon Nine Lives Stealer. It has +2 to hit and damage. Also, as long as it has charges left, when it does a critical hit against a creature with fewer than 100 HP, that creature must make a DC 15 Constitution saving throw or die.'
		],
		atkCalc: [
			function (fields, v, output) {
...
MagicItemsList["nolzur's marvelous pigments"] = {
	...
	descriptionLong: "This wooden box contains 1d4 pots of pigments and a brush. I can use the brush and 1 pot of pigment to paint any number of 3d objects and terrain features - confined to a 20-ft cube. It takes 10 minutes, regardless of the number of elements, and I must maintain Concentration or all the elements vanish. Nothing created can have a value over 25 gp. Objects appearing of greater value look authentic but don't hold up to closer inspection. I can't use this to form energy that deals damage, like fire or lightning.",
	descriptionFull: "This wooden box contains 1d4 pots of pigments and a brush. I can use the brush and 1 pot of pigment to paint any number of 3d objects and terrain features - confined to a 20-ft cube. It takes 10 minutes, regardless of the number of elements, and I must maintain Concentration or all the elements vanish. Nothing created can have a value over 25 gp. Objects appearing of greater value look authentic but don't hold up to closer inspection. I can't use this to form energy that deals damage, like fire or lightning.",
	weight: 1
};
MagicItemsList["oathbow"] = {
	...
	"longbow": {
		...
		weaponOptions: [{
			...
			name: "Oathbow",
			source: [["PHB2024", 215]],
			description: "Ammunition, heavy, two-handed; Slow; Vs. sworn enemy: adv, +3d6 damage, no cover/range penalties",
			isMagicWeapon: true,
			selectNow: true
		},],
	}
...
MagicItemsList["orb of direction"] = {
	...
	descriptionFull: "This orb can be used as an Arcane Focus. As a Magic Action while holding this orb, I can determine which way is magnetic north. Nothing happens if the orb is used in a location that has no magnetic north.",
	weight: 3,
...
MagicItemsList["orb of time"] = {
	...
	descriptionFull: "While holding this orb, I can use a Magic Action to determine whether it is morning, afternoon, evening, or nighttime outside. This property functions only on the Material Plane.",
	weight: 3,
...
MagicItemsList["pearl of power"] = { // contains contributions by AelarTheElfRogue
	...
	descriptionFull: "While this pearl is on your person, I can take a Magic action to regain one expended spell slot of level 3 or lower. Once I have used the pearl, it can't be used again until the next dawn.",
	attunement: true,
...
MagicItemsList["periapt of health"] = { // contributed by AelarTheElfRogue
	...
	magicItemTable: "?",
	attunement: true,
	description: "While wearing this pendant, I can take a Magic Action to regain 2d4+2 HP. Once used, I cannot use it again until the next dawn. I have Adv on Saving Throws to avoid or end the Poisoned condition while wearing this pendant.",
	descriptionFull: "While wearing this pendant, I can take a Magic Action to regain 2d4+2 HP. Once used, I cannot use it again until the next dawn. I have Adv on Saving Throws to avoid or end the Poisoned condition while wearing this pendant.",
	weight: 1,
	savetxt: { adv_vs: ["poison"] },
	recovery: "dawn",
};
MagicItemsList["periapt of proof against poison"] = { // contributed by AelarTheElfRogue
	...
	descriptionFull: "This delicate silver chain has a brilliant-cut black gem pendant. While I wear it, I am immune to the poisoned condition and have immunity to poison damage.",
	weight: 1,
...
MagicItemsList["philter of love"] = {
	...
	magicItemTable: "?",
	notLegalAL: true,
	description: "Once as an action, I can drink this rose-hued liquid or administer it to another. The consumer is charmed for 1 hour by the first creature it sees within 10 minutes of drinking it.",
	descriptionFull: "Once as an action, I can drink this rose-hued liquid or administer it to another. The consumer is charmed for 1 hour by the first creature it sees within 10 minutes of drinking it.",
	weight: 0.5
};
...
MagicItemsList["pipes of the sewers"] = { // contains contributions by Soilentbrad
	...
	rarity: "uncommon",
	magicItemTable: "?",
	description: "The pipes have 3 charges, regain 1d3 at dawn, and cause rats to be indifferent toward me unless threatened. As a Magic Action, I can play them, then use a bonus action to summon rats in 0.5 miles to form 1 swarm per charge spend. While playing, rat swarms in 30 ft make a Wis Save vs. my Cha check or obey my commands.",
	descriptionLong: "The pipes have 3 charges, regain 1d3 at dawn, and cause rats to be indifferent toward me unless threatened. As a Magic Action, I can play them, then use a bonus action to summon rats within 0.5 miles to come towards me and form 1 swarm of rats per charge I spend.  When a swarm of rats that isn't under another's control comes within 30 ft of me while I play the pipes, I can make a Charisma check contested by the swarm's Wisdom Save. If the swarm fails, it obeys my commands for as long as they can hear the pipes at the start of its turn. If the swarm succeeds or it falls out of the sway, it can't be affected again for 24 hours.",
